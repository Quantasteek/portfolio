      ...
      Recent Projects
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10 '>
            {projects.map(({
                ...
                <div key={id} className='sm:h-[41rem] h-[32rem] sm:w-[570px] lg:min-h-[32.5rem] h-[25rem] items-center justify-center w-[80vw]'>
                    <PinContainer title={title}
                    href={link}>
                    <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden   mb-10 '>
                        <div className='relative w-full h-full overfllow-hidden lg:rounded-3xl bg-[#13162d]'>
